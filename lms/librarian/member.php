			   ...
			   <br><br>
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($con,"select * from member")or die(mysql_error());
									...
									<div class="span2">
										...
										<div class="span1">
										<a  rel="tooltip"  title="Edit" id="<?php echo $id; ?>" href="edit_member.php<?php echo '?id='.$id; ?>" class="btn-default"><i class="icon-pencil icon-large"></i></a>
										</div></div>
                                    </td>
