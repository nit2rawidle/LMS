...
<?php $get_id = $_GET['id']; ?>
    <div class="container">
		<div class="margin-top">
			...
			<div class="span12">	
		<?php 
		$query=mysqli_query($con,"select * from member where member_id='$get_id'")or die(mysql_error());
	...
	<form class="form-horizontal" method="POST" action="update_member.php" enctype="multipart/form-data">
		...
		<div class="control-group">
			...
			<div class="controls">
			<input type="text" id="inputEmail" name="mem_id" value="<?php echo $row['member_id']; ?>" placeholder="ID" required>
		...
		<div class="control-group">
			...
			<div class="controls">
			<input type='tel' pattern="[0-9]{10,10}" id="inputPassword" name="contact" value="<?php echo $row['contact']; ?>" placeholder="Phone Number"  autocomplete="off"  maxlength="11" >
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
			<input type="email" id="inputEmail" name="Email" value="<?php echo $row['email_id']; ?>" placeholder="Email" required>
			<input type="hidden" id="inputEmail" name="id" value="<?php echo $get_id;  ?>" placeholder="Email" required>
			</div>
		</div>
